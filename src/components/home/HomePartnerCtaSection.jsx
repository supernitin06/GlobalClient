  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-6 grid items-stretch gap-6 lg:grid-cols-2">
      <ScrollReveal variant="up">
        <article className="flex min-h-[350px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_16px_30px_rgba(15,23,42,0.08)]">
      ...
      <ScrollReveal variant="zoom" delay={120}>
        <article className="relative flex min-h-[350px] flex-col justify-between overflow-hidden rounded-3xl border border-[rgba(13,110,253,0.26)] bg-[linear-gradient(145deg,rgba(13,110,253,0.1),rgba(255,193,7,0.14))] p-7 shadow-[0_16px_30px_rgba(15,23,42,0.1)]">
